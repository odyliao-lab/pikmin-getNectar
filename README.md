...
開發中1.4.15/code49補齊零結束時間的搬運水果（含散步拾取／蘑菇獎勵），沿用原生領取與控制檔。1.4.14唯讀快照已定位到Carry水果使用預設完成欄位0，1.4.15據此修正限定條件；新版實際入庫驗證尚未完成，既有dist暫不替換。[條件、測試與接續](CARRY_CLAIM_2026-09-06.md)。
