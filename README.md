...
最新1.4.19/code53搭配CC0.6.12/code29，新增一般200m自動派遣的水果／花苗／禮物盒篩選，預設水果＋花苗；CC入口移到返程頁。控制檔獨立於批次／花田，全部不勾不新增派遣；保留忙碌隊員排除與禮物專屬ID限制。詳見[控制協定與驗證邊界](NEARBY_KINDS_2026-09-06.md)。
