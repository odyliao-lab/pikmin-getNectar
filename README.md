...
最新候選1.4.21/code55搭配CC0.6.15/code32：一般附近派遣須符合遊戲處理後位置200m、定位同步穩定、跨tick同隊重驗及原生往返≤120秒。保留3筆並行；批次／花田既有流程不改。1.4.21修正遊戲開機時鐘比較，**已在Android14重開載入、靜止ready，並完成一筆原生往返4.581秒花苗的派遣與自動領取紀錄確認**；派遣關閉時，遠距離往返均重現3個中繼點，guard等待追上及穩定後才ready。**armed跳點負向測試、多筆並行及回歸仍待驗收，目前GPS已還原、附近派遣off**。[安全規則、備份及待驗證項目](NEARBY_SAFETY_2026-09-06.md)。
