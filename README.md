...
**已知限制（2026-09-05）：** 1.4.9 曾在使用者確認禮物專屬皮克敏全忙於蘑菇時仍顯示選隊數 1；候選數不是可派遣證明。1.4.11 已實測在 picker ID 與禮物指定 ID 不符時拒絕派遣，但完整禮物派遣與伺服器／UI 狀態比對仍待驗證；目前庫存投影不能單獨證明指定皮克敏真正閒置。1.4.9 本身沒有批次 2 秒硬閘門，需更新至 1.4.11 才有已通過回歸的新保護。
